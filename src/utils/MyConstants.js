...
export const NOTE_DETAIL_PLACEHOLDER = "Type your awesome note detail";
...
export const INSERT_SUGGEST = "Inserted Successfully";
export const DELETE_SUGGEST = "Deleted Successfully";
